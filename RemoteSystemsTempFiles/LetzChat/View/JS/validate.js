...
//    
//    if (loginName == "") {
//        displayErrors("showLoginError", "loginName", 0, this.firstBlankField);
//        loggedIn=false;
//    } else if (loginName.length < 3) {
//        displayErrors("showLoginError", "loginName", 1, this.firstBlankField);
//        loggedIn=false;
//    }
//     else {
//        clearErrorDisplayed('showLoginError');
//        loggedIn=true;
//    }
//    
//    
//    if (passkey == "") {
//        displayErrors("showErrorPasskey", "password", 0, this.firstBlankField);
//        loggedIn=false;
//    } 
//    else {
